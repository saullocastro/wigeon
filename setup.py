...
def write_version_py(version, is_released, filename='wigeon/version.py'):
    fullversion = get_version_info(version, is_released)
    with open("./wigeon/version.py", "wb") as f:
...
s = setup(
    name = "wigeon",
    version = fullversion,
    author = "Georgiana Maties, Saullo G. P. Castro",
    author_email = "S.G.P.Castro@tudelft.nl",
    description = ("Python module based on the long-range eVTOL concept Wigeon"),
    license = "3-Clause BSD",
    keywords = "eVTOL design",
    url = "https://github.com/saullocastro/wigeon",
